...
export default function LectureCard({
  ...
  return (
    <div className="flex items-center gap-6 p-5 bg-white rounded-xl shadow-sm ring-1 ring-gray-200 hover:shadow-md transition w-full">
      {/* 이미지 */}
      <img
        src={imageUrl}
        alt="교수 프로필"
      ...
      <div className="flex justify-between items-center w-full gap-4 min-w-0">
        ...
        {/* 버튼 */}
        {variant === 'enroll' ? (
          <div className="flex flex-nowrap items-center gap-2 whitespace-nowrap flex-shrink-0">
            <button
              onClick={onPlanClick}
            ...
            <button
              ...
              className="px-4 py-2 bg-blue-700 text-white text-sm font-medium rounded-md hover:bg-blue-600 transition"
            >
              추가
            </button>
          </div>
