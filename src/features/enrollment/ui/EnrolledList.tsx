...
export default function EnrolledList({
  ...
  return (
    <aside className="w-[460px] flex-shrink-0 space-y-6">
      <div className="flex justify-between items-center mr-2">
        <h2 className="text-3xl font-semibold text-gray-800">선택한 강의</h2>
        {lectures.length > 0 && (
          <button
            onClick={onRemoveAll}
      ...
      <button
        ...
        className="w-full py-3 bg-blue-700 text-white font-semibold rounded-md hover:bg-black transition"
      >
        등록하기
      </button>
    </aside>
